...
class ANN:
    def __init__(self, num_input_features, num_hidden_units, num_outputs, hidden_unit_activation, output_activation, loss_function, iters_no_change =5,  tol = 0.005 ):
        ...
        self.iters_no_change = iters_no_change
        self.tol = tol
    ...
    def update_no_improvement_iters(self, losses):
        
        if   losses[-1] > self.best_loss - self.tol:
            self.no_improvement_iters += 1
        else:
            self.no_improvement_iters = 0
    ...
    def train(self, train_data, train_target, learning_rate=0.5, num_epochs=200):
        ...
        for epoch in range(num_epochs):           
            ...
            self.update_no_improvement_iters(losses)
            
            if self.no_improvement_iters > self.iters_no_change:
                #Update the learning rate by dividing it with 5
